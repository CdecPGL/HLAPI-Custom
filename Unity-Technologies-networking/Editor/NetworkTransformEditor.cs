...
namespace PlanetaGameLabo.Editor {
    ...
    public class NetworkTransformEditor : UnityEditor.Editor {
        ...
        public void Init()
        {
            ...
            m_MovementThesholdLabel = EditorGUIUtility.TrTextContent("Movement Threshold", "The distance that this object can move without sending a movement synchronization update.");
            m_VelocityThresholdLabel = EditorGUIUtility.TrTextContent("Velocity Threshold", "The minimum velocity difference that will be synchronized over the network.");
            m_SnapThresholdLabel = EditorGUIUtility.TrTextContent("Snap Threshold", "If a movement update puts this object further from its current position that this value, it will snap to the updated position instead of moving smoothly.");
            ...
            m_SyncSpinLabel = EditorGUIUtility.TrTextContent("Sync Angular Velocity", "Enable to sync angular velocity.");
            EditorGUI.indentLevel -= 1;
        }
